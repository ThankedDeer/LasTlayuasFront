  ...
  return (
    <section className="h-screen grid grid-cols-2">
      <div className="place-content-center">
        ...
        <h2 className="font-RobotoSerif font-bold text-3xl text-vibrantPink">
          Nuestra Historia
        </h2>
        <p className="font-Roboto text-lg">
          Hola, somos Eduardo Salinas García y Amanda García Cruz, originarios
          de San Francisco Ixhuatán, Oaxaca. Desde temprana edad, hemos estado
          inmersos en la rica tradición culinaria de nuestra región. Inspirados
          por las recetas ancestrales y el amor por la cocina de Amanda, mi
          madre, decidimos emprender esta aventura para compartir los sabores
          auténticos y la cultura de nuestra tierra con nuestra comunidad y más
          allá.
          <br />
          <br />
