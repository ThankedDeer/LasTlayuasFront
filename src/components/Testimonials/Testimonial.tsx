    ...
    return (
        <section className="grid grid-cols-2 max-w-full h-screen items-center ">
            <div className="">
                ...
                <Button className="bg-black text-white font-semibold mt-4" radius="none" variant="solid" size="lg" onPress={onOpen}>
                    Agrega reseña
                </Button>
                <FormModal GetTestimonios={GetTestimonios} isOpen={isOpen} onOpenChange={onOpenChange} onOpen={onOpen} />
